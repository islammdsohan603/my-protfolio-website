        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-6 order-2 lg:order-1">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-black leading-1.0 tracking-tight">
                SOHAN
                <br />
                <span
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -bottom-5 -left-6 bg-[#1e293b] border border-white/10 rounded-2xl px-4 py-2.5 shadow-xl"
              >
